    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<DDNSPage>();
                services.AddSingleton<HowToPage>();
                services.AddSingleton<ChangeLogPage>();
                services.AddSingleton<PropertiesPage>();
                services.AddSingleton<PropertiesVM>();
                services.AddSingleton<PlayerSettingsPage>();
